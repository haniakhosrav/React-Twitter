...
export {TweetProvider, useTweetState, useTweetDispatch, 
  setTweetText, likeTweet, setTweetList, 
  setHeaderTitle, setHashtagList, updateHashtagList};
...
function setHeaderTitle(dispatch, title) {
  dispatch({
